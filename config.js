module.exports.GETHUBTOKEN = process.env.GETHUBTOKEN;
module.exports.REPOSITORY = process.env.REPOSITORY;
module.exports.OWNER = process.env.OWNER;
module.exports.DEPLOYLABEL = process.env.DEPLOYLABEL;
